...
header("Location: http://192.168.130.86/janus_reporting/");
exit();
...
/*if(strlen($_SESSION['alogin'])==0 || $_SESSION['site'] != "S2")
{
    ...
    $tsql = "
            ...
            FROM (
                ...
                WHERE
                    ...
                    AND dbo.facture_ligne.AR_Ref NOT IN ('LIVRAISON','ZDIVERS','ZTAXE','DISCOUNT','05024349','05024350','05024351','05024355','SAVDEP','SAVHB','SAVHT','SAVPCDET','10037140','10037151','90010009','90010003','10037149','90010001','10037162','90010013','LIVCIMENT')
