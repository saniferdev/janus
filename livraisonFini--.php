    ...
    $tsql = "
            ...
            FROM (
                ...
                WHERE
                    ...
                    ".$q_w."
                    AND ( dbo.facture_ligne.statut = 1 OR (dbo.facture_ligne.DL_Qte = dbo.facture_ligne.DL_QTEP AND dbo.facture_ligne.statut != 9 )) 
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h5>Livraison fini</h5>
                        </div>


                        <div class="panel-body">
                            
                            <form method="get" action="livraisonFini.php" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 expFini" style="padding-bottom: 15px; margin-top: -25px;">
                                <button class="btn btn-success xlsxFini" >Export to Excel</button>
                            </div>
