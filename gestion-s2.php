                                                ...
                                                <?php foreach($data as $val){
                                                    ...
                                                    <tr class="">
                                                      <form method="post">
                                                        ...
                                                        <td><?php echo (empty($val->DL_Design)?$val->AR_Design:$val->DL_Design); ?><input type="hidden" name="numBont[]" class="form-control numBon" id="numBon" value="<?php if(isset($numBon)){echo $numBon;} ?>"></td>
