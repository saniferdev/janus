...
<input type="hidden" id="dateDebut" name="date_debut">
<input type="hidden" id="dateFin" name="date_fin">
<button class="btn btn-success" name="transmission" type="submit" style="margin-bottom:10px;margin-top:-20px;margin-left: 45px;">Export to Excel</button>
</form>
